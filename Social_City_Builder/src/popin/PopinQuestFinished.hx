...
{	
	...
	private var gui:GUI;
	private var guiValuesList:Array<String> = ["articleInterline","ressourcesBackX","ressourcesBackY","ressourceBaseX","ressourceBaseY","ressourceImgX","ressourceImgY","ressourcesTxtX","ressourcesTxtY","ressourcesNbX","ressourcesNbY"];
	...
	private function addQuest() {
		...
		addIcon(-0.55,0.16,'assets/Dogs/Dog' + quest.dog + '.png',"dog",this,false);
	}
