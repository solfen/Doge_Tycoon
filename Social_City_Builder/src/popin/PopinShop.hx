...
{	
	private var articleHeight:Float = Texture.fromFrame("assets/UI/PopInShop/PopInShopBgArticle.png").height;
	...
	private function new(?startX:Float,?startY:Float) 
	{
		...
		headerTextures = [
			'softTab'=>Texture.fromFrame('assets/UI/PopInShop/PopInHeaderDogflooz.png'),
			'hardTab'=>Texture.fromFrame('assets/UI/PopInShop/PopInHeaderOsDOr.png'),
		];
		articleHeight /= background.height; // background is defiened in MyPopin

		addHeader(0.65,0.05,headerTextures['softTab']);
		addIcon(-0.15,-0.15,'assets/UI/PopInShop/PopInTitleShop.png',"popInTitle",this,false);
		addIcon(0.09,0.15,'assets/UI/PopIn/PopInScrollBackground.png',"contentBackground",this,false);
		addIcon(0.65, 0.875,'assets/UI/PopInShop/PopInShopButtonConfirmNormal.png',"confirmBtn",this,true,'assets/UI/PopInShop/PopInShopButtonConfirmActive.png',true);

		addIcon(-0.02,0.17,'assets/UI/PopInShop/PopInOngletSoftNormal.png',"softTab",this,true,'assets/UI/PopInShop/PopInOngletSoftActive.png',true);
		addIcon(-0.02,0.29,'assets/UI/PopInShop/PopInOngletHardNormal.png',"hardTab",this,true,'assets/UI/PopInShop/PopInOngletHardActive.png',true);
	...
	private function addMarketArticles(ItemsConfig:Map<String,Dynamic>){
		...
		for(i in ItemsConfig){
			...
			addIcon(0.115,0.17+y,'assets/UI/PopInShop/PopInShopBgArticle.png',"articleBase",containers["verticalScroller"],false);
			...
			addIcon(0.757,0.24+y,'assets/UI/PopInShop/PopInMarketValidNormal.png',"validBtn"+cpt,containers["verticalScroller"],true,'assets/UI/PopInShop/PopInMarketValidActive.png',true);
