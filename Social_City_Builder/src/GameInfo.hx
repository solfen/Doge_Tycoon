...
class GameInfo
{
 	...
 	public static var buildMenuArticles:Dynamic = {
 		...
 		"spacechips": [
 			{
 				buildingID: Building.HANGAR_BLEU | Building.LVL_1,
 			...
 			{
 				buildingID: Building.HANGAR_CYAN | Building.LVL_1,
 			...
 			{
 				buildingID: Building.HANGAR_JAUNE | Building.LVL_1,
 			...
 			{
 				buildingID: Building.HANGAR_ROUGE | Building.LVL_1,
 			...
 			{
 				buildingID: Building.HANGAR_VERT | Building.LVL_1,
 			...
 			{
 				buildingID: Building.HANGAR_VIOLET | Building.LVL_1,
